...
Begin
  ...
  Readln;
  IsConsole := False;  //In order that a memory leak report can appear in a popup window
  //IsConsole := False; //stops input/output via console window which will at this stage be closed
End.
